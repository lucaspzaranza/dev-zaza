...
import nextjs from "./assets/svg/skills/next-js.svg";
...
export default {
  pt: {
    ...
    aboutMe: {
      ...
      country: "Brasil",
      description: [
        "Desenvolvedor há cerca de 11 anos, iniciei minha carreira com desenvolvimento de jogos e depois fui adquirindo experiência com o desenvolvimento de sistemas. Passei um bom tempo atuando com os jogos, e por volta de 2020 resolvi estudar o desenvolvimento de sistemas e trabalhar como desenvolvedor Web.",
    ...
    careerData: [
      ...
      },
      {
        ...
        startDate: "JAN 2025",
        endDate: "MAI 2025",
        techs: "NextJS, React, Tailwind CSS, ROSLib",
        jobDescription: [
          "Trabalhei como prestador de serviços para uma empresa de robótica onde fui contratado para desenvolver o dashboard de um sistema que se comunicava com os robôs da empresa, do modelo Unitree GO2, utilizando a biblioteca ROSLib.",
        ],
      },
    ],
    projectsData: [
      {
        ...
        img: "",
        imgWidth: "",
        techs: "NextJS, Tailwind, ROSLib",
        link: "https://front-robotics.vercel.app/",
      ...
      {
        name: "Landing Page Elisa Ferraz",
        img: "",
        imgWidth: "",
  ...
  en: {
    ...
    careerData: [
      ...
      },
      {
        ...
        techs: "NextJS, React, Tailwind CSS, ROSLib",
        jobDescription: [
          "I've worked as a service provider to a robotics company where I was hired to develop the system dashboard which communicates itself with their robots, such as Unitree GO2, using the ROSLib library.",
        ],
      },
    ],
    projectsData: [
  ...
  links: [
    {
      name: "Linkedin",
      link: "https://www.linkedin.com/in/lucaszaranza",
    },
...
export const techLevel = {
  pt: ["Iniciante", "Experiente", "Avançado"],

  en: ["Beginner", "Skilled", "Advanced"],
};
