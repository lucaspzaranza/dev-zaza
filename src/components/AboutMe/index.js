...
import AboutStyles, { MainData } from "./aboutStyles";
import cmd from '../../assets/svg/profile-bold.svg'
...
export default function AboutMe() {
    ...
    const yearsOld = (new Date()).getFullYear() - dateOfBirth.getFullYear();

    return (
        <AboutStyles>
            <span><img src={cmd}/> {data[lang].aboutMe.name}</span>
